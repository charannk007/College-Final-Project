 ...
 <div class="wrapper home2">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="index.jsp"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Home </a>
                     </li>   
                     <li class="nav-item"> <a class="nav-link" href="contact-one.html">Contact US</a> </li>
						<li class="nav-item"> <a class="nav-link" href="my-account.jsp">Login</a> </li>
         ...
         <section id="home-slider" class="owl-carousel owl-theme wf100">
            <div class="item">
               <div class="slider-caption h2slider">
                  <div class="container">
                     <strong>FarmAssistant<span> is the Best</span></strong>
                     <h1>Connecting Suppliers</h1>
                     <p>with best productivity Farmers</p>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-sm-6 col-md-3">
                        <div class="counter-box">
                           <p class="counter-count">12345</p>
                           <p class="ctxt">Trees Planted</p>
                        </div>
                     </div>
                     <div class="col-lg-3 col-sm-6 col-md-3">
                        <div class="counter-box">
                           <p class="counter-count">1234</p>
         ...
         <section class="why-ecova wf100">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <h1> Why Farmer Assistant!</h1>
                     <p>Let’s Join us to do something awesome to serve, encourage, make bussiness
                        with farmers and create mutual understanding with suppliers.
                     </p>
                     <a href="my-account.jsp" class="cus">Signup to Join us</a> 
                  </div>
               </div>
            </div>
         </section>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="section-title-2 text-center">
                        <h5>Get Our Latest</h5>
                        <h2>Agricultural Plants &amp; Seeds Product</h2>
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="product-box">
                        ...
                        <div class="pro-txt">
                           ...
                           <p class="pro-price"><del>Rs.25.00</del> Rs.19.00</p>
                        </div>
                     </div>
                  </div>
                  <!--Pro Box End--> 
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="product-box">
                        ...
                        <div class="pro-txt">
                           <h6><a href="#">Rice Premium Quality</a></h6>
                           <p class="pro-price"><del>Rs.25.00</del> Rs.19.00</p>
                        </div>
                     </div>
                  </div>
